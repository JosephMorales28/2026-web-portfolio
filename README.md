# New Release on 2026 webportfolio v1.1.6
![Banner](/public/img/banner/websiteportfoliov1.1.6.webp)

### Features in `v1.1.6`
- Update index.html on main tag by [@JosephMorales28](https://github.com/JosephMorales28)
- Update About.html new hero image banner by [@JosephMorales28](https://github.com/JosephMorales28)
- Upgrade image webp to avif by using image magick cmd by [@JosephMorales28](https://github.com/JosephMorales28)
- Update blog.html for v1.1.6 by [@JosephMorales28](https://github.com/JosephMorales28)
- Fixed main.js script in main tag on both pages by [@JosephMorales28](https://github.com/JosephMorales28)
...
### Installation
click the Assets on the release version of v1.1.6 in github release or on the code button Download ZIP release version of `v1.1.6`
